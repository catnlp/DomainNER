...
class Data:
    ...
    def generate_instance(self, name):
        ...
        #                                                  self.number_normalized, self.MAX_SENTENCE_LENGTH)
            ...
            self.test_texts, self.test_Ids = read_instance(self.test_dir, self.word_alphabet, self.feature_alphabets,
                                                           self.label_alphabet, self.number_normalized, self.MAX_SENTENCE_LENGTH)
        elif name == "raw":
            self.raw_texts, self.raw_Ids = read_instance(self.raw_dir, self.word_alphabet, self.feature_alphabets,
                                                         self.label_alphabet, self.number_normalized, self.MAX_SENTENCE_LENGTH)
        else:
